...
seuratE18EYFP.int$label[which(seuratE18EYFP.int$intCluster == "0")] <- "TRC1"
seuratE18EYFP.int$label[which(seuratE18EYFP.int$intCluster == "1")] <- "ProlifTRC"
seuratE18EYFP.int$label[which(seuratE18EYFP.int$intCluster == "2")] <- "VSMC"
seuratE18EYFP.int$label[which(seuratE18EYFP.int$intCluster == "3")] <- "TRC2"
seuratE18EYFP.int$label[which(seuratE18EYFP.int$intCluster == "4")] <- "PRC"
seuratE18EYFP.int$label[which(seuratE18EYFP.int$intCluster == "5")] <- "ProlifVSMC"

table(seuratE18EYFP.int$label)
##order
seuratE18EYFP.int$label <- factor(seuratE18EYFP.int$label, levels = c("TRC1", "TRC2", "ProlifTRC", "PRC", "VSMC", "ProlifVSMC"))
table(seuratE18EYFP.int$label)

colLab <- c("#900C3F","#b66e8d", "#003C67FF",
            "#e3953d", "#714542", "#b6856e")

names(colLab) <- c( "TRC1", "TRC2","ProlifTRC", "PRC", "ProlifVSMC", "VSMC")
```
...
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "0")] <- "TRC1"
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "1")] <- "ProlifTRC"
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "2")] <- "PRC"
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "3")] <- "VSMC"
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "4")] <- "TRC2"
...
##order
seuratE18EYFPv2.int$label <- factor(seuratE18EYFPv2.int$label, levels = c("TRC1", "TRC2", "ProlifTRC", "PRC", "VSMC", "Adipoc", "Mesothelial"))
table(seuratE18EYFPv2.int$label)

colLab <- c("#900C3F","#b66e8d", "#003C67FF",
            "#e3953d", "#714542", "#b6856e","grey")

names(colLab) <- c( "TRC1", "TRC2","ProlifTRC", "PRC", "Adipoc", "VSMC", "Mesothelial")
```
