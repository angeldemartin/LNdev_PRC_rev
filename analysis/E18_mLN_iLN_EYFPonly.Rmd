...
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "4")] <- "mLTo2"
...
##order
seuratE18EYFPv2.int$label <- factor(seuratE18EYFPv2.int$label, levels = c("mLTo1", "mLTo2", "mLTo3", "mLTo4", "Adipoc", "Mesothelial", "Prolif"))
table(seuratE18EYFPv2.int$label)
