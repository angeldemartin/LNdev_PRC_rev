...
write.table(markerGenes, 
            file= "/Users/immbio/Desktop/Project/Angelina/LNdev_PRC_rev/data/markerGenes_E18_EYFPpos_integrated_intCluster",
            sep="\t",
            quote=F,
            row.names=F,
            col.names=T)
...
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "0")] <- "mLTo1"
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "1")] <- "mLTo2"
seuratE18EYFPv2.int$label[which(seuratE18EYFPv2.int$intCluster == "2")] <- "mLTo3"

table(seuratE18EYFPv2.int$label)
##order
seuratE18EYFPv2.int$label <- factor(seuratE18EYFPv2.int$label, levels = c("mLTo1", "mLTo2", "mLTo3"))
table(seuratE18EYFPv2.int$label)

colLab <- c("#900C3F","#b66e8d", "#003C67FF")

names(colLab) <- c("mLTo1", "mLTo2", "mLTo3")
```
